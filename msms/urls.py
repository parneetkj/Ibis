...
urlpatterns = [
    ...
    path('delete_admin/<name>', views.delete_admin, name='delete_admin'),
    path('create_admin', views.create_admin, name = 'create_admin'),
    path('update_admin/<int:pk>', views.update_admin, name = 'update_admin'),
    path('promote_admin/<int:pk>', views.promote_admin, name='promote_admin'),
    ...
    path('student_transfers/', views.student_transfers, name='student_transfers'),
]
