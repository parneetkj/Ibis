...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2022, 12, 4, 20, 58, 15, 673222, tzinfo=datetime.timezone.utc))),
                ('time', models.TimeField(default=datetime.datetime(2022, 12, 4, 20, 58, 15, 673241, tzinfo=datetime.timezone.utc))),
