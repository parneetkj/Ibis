    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.FloatField(validators=[django.core.validators.MinValueValidator(limit_value=1, message='Too cheap'), django.core.validators.MaxValueValidator(limit_value=100, message='Too expensive')])),
