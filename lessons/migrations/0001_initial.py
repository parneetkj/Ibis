...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2022, 12, 5, 23, 56, 17, 173509, tzinfo=datetime.timezone.utc))),
                ('time', models.TimeField(default=datetime.datetime(2022, 12, 5, 23, 56, 17, 173527, tzinfo=datetime.timezone.utc))),
